...
export default function ToolTip({
  ...
  return (
    <div
      className={cn(
        `invisible absolute left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black px-1 py-0.5 text-xs
         text-white opacity-0 bg-opacity-60 [transition:visibility_0ms_ease_200ms,opacity_200ms_ease]`,
        groupInner
